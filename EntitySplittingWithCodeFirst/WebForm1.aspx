<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="EntitySplittingWithCodeFirst.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="EntitySplittingWithCodeFirst.Employee" DeleteMethod="DeleteEmployee" InsertMethod="InsertEmployee" SelectMethod="GetEmployees" TypeName="EntitySplittingWithCodeFirst.EmployeeRepository" UpdateMethod="UpdateEmployee"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
