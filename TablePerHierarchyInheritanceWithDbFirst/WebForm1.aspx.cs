...
namespace TablePerHierarchyInheritanceWithDbFirst
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "Permanent":
                    GridView1.DataSource = employeeDBContext.Employs
                ...
                default:
                    GridView1.DataSource = ConvertEmployeesForDisplay(
                        employeeDBContext.Employs.ToList());
                    GridView1.DataBind();
                    break;
            }
        }

        private DataTable ConvertEmployeesForDisplay(List<Employ> employees)
        {
            ...
            foreach (Employ employee in employees)
            {
